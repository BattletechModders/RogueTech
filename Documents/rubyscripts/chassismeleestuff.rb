...
Dir.glob('**/chassisdef_*.json').each do |filename|
  ...
  puts parsed
  puts "-------"
  parsed["MeleeDamage"] = (parsed["Tonnage"] / 2.0).ceil
  parsed["MeleeInstability"] = (parsed["Tonnage"] / 4.0).ceil
  parsed["DFADamage"] = parsed["Tonnage"]
  parsed["DFASelfDamage"] = parsed["Tonnage"]
  parsed["DFAInstability"] = (parsed["Tonnage"] / 2.0).ceil
  puts parsed
  puts "-------"
