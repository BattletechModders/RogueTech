...
Source: "/ElitePilots/*"; Excludes: "log.txt"; DestDir: "{app}/Mods/ElitePilots"; Flags: recursesubdirs ignoreversion createallsubdirs; Components: RogueTechOptionals\ElitePilots;
